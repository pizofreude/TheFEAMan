...
| Salome-Meca (Pre-,Post-processing) / Code\_Aster | EDF | Windows, Linux, Unix | Open Source | Pre-processing, Meshing, Solver, Post-processing, Coupled Multiphysics Analysis / Solver, Nonlinear Analysis, Dynamic Analysis, Heat Transfer, Contact Analysis, Material Models | Available for Educational/Research/Free Use |
